...
$remote->sys("euare-usermod -u $another_user -p $another_user_path");
...
$remote->sys("euare-usermod -u $another_user -n $new_user_name");
...
$remote->sys("euare-groupmod -g $another_group -p $another_group_path");
...
$remote->sys("euare-groupmod -g $another_group -n $new_group_name");
